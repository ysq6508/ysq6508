<template>
    ...
    >
      <div
        id="sticky"
        class="cs ml-3 mr-3 w-11/12 h-12 border-gray-300 border-2 p-1 text-base rounded-xl pl-2 pr-2 overflow-hidden overflow-x-auto transition-all"
...
const items = ["大家都在看", "精选合集", "范文月刊", "每日速递"]
interface section {
  id: string
}
